...
exports.doRegister = function (req, res, next) {
  ...
  req.assert('firstName', 'Bitte überprüfe deine Eingabe').notEmpty().validName();
  req.assert('lastName', 'Bitte überprüfe deine Eingabe').optional().validName();
  req.assert('email', 'Bitte überprüfe deine Eingabe').notEmpty().isEmail();
  req.assert('tag1', 'Bitte überprüfe deine Eingabe').notEmpty().tag();
  req.assert('tag2', 'Bitte überprüfe deine Eingabe').notEmpty().tag();
  req.assert('tag3', 'Bitte überprüfe deine Eingabe').notEmpty().tag();
  ...
  req.assert('children', 'Bitte überprüfe deine Eingabe').optional();
  req.assert('newcomer', 'Bitte überprüfe deine Eingabe').optional();
