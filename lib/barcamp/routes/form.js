...
exports.doRegister = function (req, res, next) {
  ...
  req.assert('shirtSize').optional().isIn(['S', 'M', 'L', 'XL', 'XXL']);
  req.assert('note', 'Invalid input').optional().isAscii();
  req.assert('children', 'Invalid input').optional().isNumeric();
  req.assert('newcomer', 'Invalid input').optional().equals('on');
