...
p.setupRoutes = function () {
  ...
  this.app.get('/list', function (req, res) {
    ...
    req.app.get('database').model.User.findAll({ where: {password: {ne: null}}}).success(function (users) {
  ...
  this.app.get('/statistics', ensureLoggedIn('/login'), function (req, res) {
    ...
    req.app.get('database').model.User.findAll().success(function (users) {
      ...
      statistics['children_yes'] = 0;
      statistics['children_no'] = 0;
      statistics['attending_day_1'] = 0;
      statistics['attending_day_2'] = 0;
      statistics['attending_day_3'] = 0;
      statistics['lastname_no'] = 0;
      statistics['lastname_yes'] = 0;
      statistics['newcomer_no'] = 0;
      statistics['newcomer_yes'] = 0;
      statistics['camp_none'] = 0;
      statistics['camp_uxcamp'] = 0;
      statistics['camp_politcamp'] = 0;
      statistics['camp_startcamp'] = 0;
      statistics['camp_designcamp'] = 0;
      statistics['camp_appdevcamp'] = 0;
      statistics['camp_wissenscamp'] = 0;
      statistics['men_s'] = 0;
      statistics['men_m'] = 0;
      statistics['men_l'] = 0;
      statistics['men_xl'] = 0;
      statistics['women_s'] = 0;
      statistics['women_m'] = 0;
      statistics['women_l'] = 0;
      statistics['women_xl'] = 0;
